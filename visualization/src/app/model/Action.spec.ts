...
describe('State Handler', () => {
  describe('Graph State Reducer', () => {
    ...
    it('should add id of expanded node to expandedNodeIds', () => {
      ...
      const state = State.build().withRootNodes([rootNode])
    ...
    it('should remove id of collapsed node from expandedNodeIds', () => {
      ...
      const state = State.build().withRootNodes([rootNode]).copy({
    ...
    it('should remove id of selected node from selectedNodeIds when toggling a selected node', () => {
      ...
      const state = State.build().withRootNodes([rootNode]).copy({ selectedNodeIds: [rootId] })
    ...
    it('should enter multiselect mode', () => {
      // given
      const rootNode = GraphNode.build()
      const state = State.build().withRootNodes([rootNode]).copy({ multiselectMode: false })
    ...
    it('should leave multiselect mode', () => {
      // given
      const rootNode = GraphNode.build()
      const state = State.build().withRootNodes([rootNode]).copy({ multiselectMode: true })
    ...
    it('should clear selected nodes when leaving multiselect mode', () => {
      // given
      const rootNode = GraphNode.build()
      const state = State.build().withRootNodes([rootNode]).copy({ multiselectMode: true, selectedNodeIds: [rootNode.id] })
    ...
    it('should restore all hidden nodes', () => {
      ...
      const state: State = State.build().withRootNodes([rootNode]).copy({
