...
- [x] Implement TSX dependency support — see `plans/tsx-dependency-support.md`
- [x] Delete TypeScript legacy query/model/tsconfig files
...
- [x] Delete JavaScript legacy query files and data classes
